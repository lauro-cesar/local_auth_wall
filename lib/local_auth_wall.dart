...
import 'package:local_auth_wall/src/auth_wall_overlay_controller.dart';
import 'package:provider/provider.dart';
import '/src/auth_wall_boot_controller.dart';
...
class _LocalAuthWallState extends State<LocalAuthWall> {
  ...
  ///
  String get defaultHelpText => widget.appConf[AuthWallConfProperty
      .defaultHelpText];

  bool  get autoAuthRootRoute => widget.appConf[AuthWallConfProperty
      .autoAuthRootRoute];

  String get defaultRouteName => widget.appConf[AuthWallConfProperty
      .defaultRouteName];
  ...
  Widget build(BuildContext context) {
    ...
    primary: false,
    body:AuthWallOverlayController()));
  }
}
